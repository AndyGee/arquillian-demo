...
Docker Machine effectively replaces the old Boot2Docker (although it basically still is under the hood).
It has been redesigned to make the provisioning of Docker images m more accessible.
